...
export class FlightlistComponent implements AfterViewInit{
  ...
  // 'windDate', 'airlineNumber', 'originAirport', 'destAirport'
  ...
  onGet(){
    console.log(this.sfservice.flightdate+'   '+this.sfservice.startlocation+
      '   '+this.sfservice.destinationlocation);
    const date = 'date='+this.sfservice.flightdate.getFullYear()
      +'-'+(this.sfservice.flightdate.getMonth()+1)+'-'+this.sfservice.flightdate.getDate();
